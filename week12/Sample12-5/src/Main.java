...
public class Main {
    public static void main(String[] args) {
        String[][] students = new String[][] {{"홍길동","남",""}, {"강성우","남",""}, {"김소이","여",""}, {"김준석","남",""}, {"장한별","여",""},
                {"조민기","남",""},{"최장빈","남",""}, {"황연준","여",""}{"파트마","여",""}, {"미라치","남",""}};
        ...
        Compute.standard(height, weight);
        Compute.bmi(students, height, weight);
        Compute.check(students, height, weight);
